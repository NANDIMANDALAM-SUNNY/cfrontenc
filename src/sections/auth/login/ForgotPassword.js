...
const ForgotPassword = () => {
  ...
  const [notification,setNotification] = useState("")
    ...
    const handleSubmit =async ()=>{
          console.log(email)
          setEmail('')
        await axios.post(`http://localhost:8000/users/forgot-password`, {"email":email})
        .then((res) => {
...
>
 <Card>
 <CardMedia>
  <img alt="forgotimage" src="https://static.vecteezy.com/system/resources/previews/002/098/231/original/man-forgot-password-to-login-concept-illustration-vector.jpg" style={{width:"300px",height:"250px"}}/>
 </CardMedia>
 <CardContent>
